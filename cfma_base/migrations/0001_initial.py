    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PATRON', 'Patron'), ('SECRETAIRE', 'Secrétaire'), ('COMMERCIAL', 'Commercial'), ('CLIENT', 'Client'), ('APPRENANT', 'Apprenant'), ('INFORMATICIEN', 'Informaticien')], default='CLIENT', max_length=20)),
